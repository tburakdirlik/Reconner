...
def banner ():
    ...
    print(colored("#                                   ____  __________  ____  _   __ _   ____________                                  #",'yellow'))
    print(colored("#                                  / __ \/ ____/ ___\/ __ \/ | / // | / / ____/ ___\                                 #",'yellow'))
    print(colored("#                                 / /_/ / /__ / /   / / / /  |/ //  |/ / /___/ /_/ /                                 #",'yellow'))
    print(colored("#                                / _  _/ /___/ /___/ /_/ / /|  // /|  / /___/ _  _/                                  #",'yellow'))
    print(colored("#                               /_/ |_/_____/\____/\____/_/ |_//_/ |_/_____/_/ |_|                                   #",'yellow'))
    print(colored("######################################################################################################################",'yellow'))
